...
public class SpringBootCoreApplication {
    ...
    public static void main(String[] args) {
        ...
        EmailService alternativeEmailService = context.getBean("alternativeEmailService", EmailService.class);
        ...
        NotificationService alternativeNotificationService = context.getBean( // Identico al 3.a
                "notificationService",
